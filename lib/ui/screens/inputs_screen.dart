...
class _InputsScreenState extends State<InputsScreen> {
  ...
  String _email ='';
  String _fecha = '';
  final TextEditingController _inputFieldDataController = TextEditingController();//controlador que obtiene la información de las cajas de texto
  ...
  Widget _crearEntradaNombre(){
    return TextField(
      ...
      style: const TextStyle(color: Color.fromARGB(255, 12, 27, 37), //da el color a la fuente dentro d ela caja de texto
      fontWeight: FontWeight.bold, //da el estilo a la fuente dentro de la caja de texto
      ),
      ...
      maxLines: null, //la caja de texto de expande para recibir mucho texto en 'null' o se fija número de líneas
...
Widget _crearEntradaMail(){
  ...
  Widget _crearEntradaDate(){
    return TextField(
      enableInteractiveSelection: false, //quita la selección interactiva de toda la caja de texto
      textAlign: TextAlign.left,
      style: const TextStyle(color: Color.fromARGB(255, 12, 27, 37), //da el color a la fuente dentro d ela caja de texto
      fontWeight: FontWeight.bold, //da el estilo a la fuente dentro de la caja de texto
      ),
